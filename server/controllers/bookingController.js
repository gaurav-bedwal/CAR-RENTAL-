...
export const getUserBookings = async (req, res)=>{
    try {
        ...
        // Hardening: Filter out bookings where car might have been deleted
...
export const getOwnerBookings = async (req, res)=>{
    try {
        ...
        let bookings = await Booking.find({}).populate('car user').select("-user.password").sort({createdAt: -1 })
        
        // Hardening: Filter out bookings where car or user might have been deleted
