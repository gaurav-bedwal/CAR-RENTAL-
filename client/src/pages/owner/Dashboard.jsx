      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12 w-full'>
        ...
        <div className='p-8 bg-[#141824] border border-white/5 rounded-3xl shadow-2xl relative overflow-hidden flex flex-col justify-center'>
          ...
          <div className='flex items-center justify-between mb-4'>
             ...
             <button onClick={() => navigate('/owner/revenue-filter')} className='px-4 py-2 bg-[#0B0D17] border border-white/10 rounded-xl hover:border-primary/50 text-[10px] font-bold uppercase tracking-widest text-primary transition-all z-10 hover:bg-primary/5'>
                Filter
             </button>
          </div>
          
          <p className='text-sm text-gray-400 mb-6 font-light'>Earnings generated this month</p>
